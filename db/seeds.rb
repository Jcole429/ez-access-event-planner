...
User.create(name:'Justin Cole',email:'Justincole29@hotmail.com',password:'Jman2255!!',street:'2 Mettle Lane',city:'Wharton',state:'NJ',zip:'07885',vendor_id:1, admin: true)
